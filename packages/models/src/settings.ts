...
export const appSettingsSchema = z.object({
  ...
  defaultVehicleId: z.string().default('byd-yuan-up-401'),
  defaultTariffId: z.string().default('cn-luoyang-residential'),
  defaultChargerId: z.string().default('ac-7'),
  defaultStrategy: strategySchema.default('cheapest'),
